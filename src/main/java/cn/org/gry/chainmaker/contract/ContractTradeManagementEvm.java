 ...
 * @version 1.0
 * @description 交易管理智能合约
 * @since 2023/12/18 9:36
 * Copyright (C) 2022-2023 CASEEDER, All Rights Reserved.
 * 注意：本内容仅限于内部传阅，禁止外泄以及用于其他的商业目的
 */
@Component
public class ContractTradeManagementEvm extends BaseContractEvm {
    ContractTradeManagementEvm() {
        this.contractName = "TradeManagement" + super.version;
